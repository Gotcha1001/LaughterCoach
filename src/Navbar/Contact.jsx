        ...
        <section className="p-6 sm:p-8 md:p-10 lg:p-12 xl:p-14 2xl:p-16 bg-gray-100">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0 sm:space-x-6 mb-8">
                ...
                <div className="bg-black text-yellow-500 rounded-lg shadow-lg p-6 w-full sm:w-1/3 mx-auto">
                    ...
                    <p className="mb-2 mt-3 text-center">
                        Email: <a href="mailto:fakeemail@example.com" className="text-yellow-300 hover:underline">hvisserclyt@gmail.com</a>
                    </p>
                </div>
            ...
            <div className="flex justify-center space-x-4 mb-8">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
                    <FaFacebook size={40} className="text-blue-600 hover:opacity-75 horizontal-spin" />
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
                    <FaInstagram size={40} className="text-pink-600 hover:opacity-75 horizontal-spin" />
                </a>
                <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer">
                    <FaWhatsapp size={40} className="text-green-600 hover:opacity-75 horizontal-spin" />
                </a>
            </div>
        </section>
    );
